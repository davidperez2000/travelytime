    ...
    <main>
        <section>
            <article>
				...
				<div id="info">
					...
					<div>
						...
						<p> - Teléfono de Contacto: 600000000 - </p>
            ...
            <div>
				...
				<p>Introduzca su Correo</p> <input class="inpt" type="email" name="correo" placeholder=""  pattern="^\w+([\.-]?\w+){5}@\w+([\.-]?\w+){4}(\.\w{2,4})+$" required>
			...
			<div>
				...
				<p>Introduzca su Nombre</p> <input class="inpt" type="text" name="nombre" placeholder="" requiered>
            ...
            <div>
				...
				<p>Introduzca su Mensaje</p> <input class="inptext" type="text" name="mensaje" placeholder="" required>
			...
			<div><input class="btn btn-warning" type="submit" value="Enviar Correo"></div>
