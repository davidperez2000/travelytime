...
if (!isset($_POST) || empty($_POST)) { 
    ...
    <div id="reg1">
            ...
            <div>
            <p>Password</p> <input class="inpt" type="password" title="Introduzca su Futura Contraseña" name="pass" required>
            </div>
			</BR>
            <div>
            ...
            <div>
            <p>DNI</p> <input class="inpt" type="text" name="dni" title="Introduzca su Dni Correctamente" pattern="[0-9A-Z][0-9]{7}[A-Z]" required>
            </div>
			</br>
            <div>
            <p>Direccion</p> <input class="inpt" type="text"  title="Introduzca su Direccion" name="direccion" minlength = 9  required >
            </div>
			</br>
            <div>
            <p>Email</p> <input class="inpt" type="email" title="Introduzca su Email" name="email" pattern="^\w+([\.-]?\w+){5}@\w+([\.-]?\w+){4}(\.\w{2,4})+$" required>
            </div>
			</br>
            <div>
...
return verdad;
	...
	$body="Su usuario ha sido registrado con el nombre"+$user;
	include("correo.php");
      }else {
